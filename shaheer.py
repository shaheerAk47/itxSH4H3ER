...
##### LOGO #####
logo = """
jalan("\033[1;93m   I  T  X  S  H  A  H  E  E R ")

\033[1;91m--> GITHUB :- https://github.com/shaheerAk47/itxSH4H3ER
...
def menu():
	...
	print "1 .\x1b[1;93m\033[1;93m[ ❃ ]START CLONING PROCESS   "
        time.sleep(0.05)
        
        time.sleep(0.05)
	print "0 .\033[1;93m\033[1;93m[ ❃ ]Logout                         "
	pilih()
...
def crack():
	...
	os.system('clear')
	print logo2
	print "1 .\x1b[1;93m[ ❃ ]START PROCESS    "
        time.sleep(0.05)
...
def pilih_crack():
	...
	if peak =="":
		...
		os.system('clear')
		print logo
		jjt = raw_input("\033[1;92m🖤◆PUBLIC ID◆🖤 : \033[1;92m")
		print "-★-★--★-★--★-★--★-★--★-★--★-★--★-"
		try:
 ...
 print '\033[1;92mType (python2 shaheer.py) New Fb Start Cloning\033[1;92m....'
	print"\print"\033[1;91mTotal OK/\x1b[1;95mCheckpoint \033[1;93m: \033[1;91m"+str(len(oks))+"\033[1;93m/\033[1;96m"+str(len(cekpoint))
	print """\033[1;96m  •P R O C E S S  D O N E•" 
